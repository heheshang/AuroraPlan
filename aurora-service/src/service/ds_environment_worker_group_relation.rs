...
impl DsEnvironmentWorkerGroupRelationService for AuroraRpcServer {
    ...
    async fn get_ds_environment_worker_group_relation(
        &self,
        _req: tonic::Request<
            proto::ds_environment_worker_group_relation::GetDsEnvironmentWorkerGroupRelationRequest,
        >,
    ) -> std::result::Result<
        tonic::Response<
            proto::ds_environment_worker_group_relation::DsEnvironmentWorkerGroupRelation,
        >,
        tonic::Status,
    > {
        todo!()
    ...
    async fn create_ds_environment_worker_group_relation(
        &self,
        _req: tonic::Request<proto::ds_environment_worker_group_relation::CreateDsEnvironmentWorkerGroupRelationRequest>,
    ) -> std::result::Result<
        tonic::Response<
            proto::ds_environment_worker_group_relation::DsEnvironmentWorkerGroupRelation,
        >,
    ...
    async fn update_ds_environment_worker_group_relation(
        &self,
        _req: tonic::Request<proto::ds_environment_worker_group_relation::UpdateDsEnvironmentWorkerGroupRelationRequest>,
    ) -> std::result::Result<
        tonic::Response<
            proto::ds_environment_worker_group_relation::DsEnvironmentWorkerGroupRelation,
        >,
    ...
    async fn delete_ds_environment_worker_group_relation(
        &self,
        _req: tonic::Request<proto::ds_environment_worker_group_relation::DeleteDsEnvironmentWorkerGroupRelationRequest>,
