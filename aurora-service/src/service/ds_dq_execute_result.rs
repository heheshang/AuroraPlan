...
impl DsDqExecuteResultService for AuroraRpcServer {
    ...
    ) -> std::result::Result<tonic::Response<proto::ds_dq_execute_result::ListDsDqExecuteResultsResponse>, tonic::Status>
    {
        todo!()
    }
    ...
    ) -> std::result::Result<tonic::Response<proto::ds_dq_execute_result::DsDqExecuteResult>, tonic::Status> {
        todo!()
    }
