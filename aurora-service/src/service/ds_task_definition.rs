...
impl DsTaskDefinitionService for AuroraRpcServer {
    ...
    ) -> std::result::Result<tonic::Response<proto::ds_task_definition::ListDsTaskDefinitionsResponse>, tonic::Status>
    {
        todo!()
    }
    ...
    ) -> std::result::Result<tonic::Response<proto::ds_task_definition::DsTaskDefinition>, tonic::Status> {
        todo!()
    }
