...
impl DsClusterService for AuroraRpcServer {
    async fn list_ds_clusters(
        &self,
        _req: tonic::Request<proto::ds_cluster::ListDsClustersRequest>,
    ) -> std::result::Result<tonic::Response<proto::ds_cluster::ListDsClustersResponse>, tonic::Status> {
        let pool = &self.pool;
        ...
        Model::page(&search_val, page_num, page_size, pool)
            ...
            .map(|(items, total_page, total, start, current_page)| {
                tonic::Response::new(proto::ds_cluster::ListDsClustersResponse {
    ...
    async fn get_ds_cluster(
        &self,
        _req: tonic::Request<proto::ds_cluster::GetDsClusterRequest>,
    ) -> std::result::Result<tonic::Response<proto::ds_cluster::DsCluster>, tonic::Status> {
        todo!()
    }

    async fn create_ds_cluster(
        &self,
        _req: tonic::Request<proto::ds_cluster::CreateDsClusterRequest>,
    ) -> std::result::Result<tonic::Response<proto::ds_cluster::DsCluster>, tonic::Status> {
        let pool = &self.pool;
    ...
    async fn update_ds_cluster(
        &self,
        _req: tonic::Request<proto::ds_cluster::UpdateDsClusterRequest>,
    ) -> std::result::Result<tonic::Response<proto::ds_cluster::DsCluster>, tonic::Status> {
        let pool = &self.pool;
    ...
    async fn delete_ds_cluster(
        &self,
        _req: tonic::Request<proto::ds_cluster::DeleteDsClusterRequest>,
    ...
    async fn verify_ds_cluster(
        &self,
        _request: tonic::Request<proto::ds_cluster::VerifyClusterRequest>,
    ) -> std::result::Result<tonic::Response<()>, tonic::Status> {
        let pool = &self.pool;
