...
impl DsAlertPluginInstanceService for AuroraRpcServer {
    ...
    > {
        ...
        Model::page(&search_val, page_num, page_size, pool)
            ...
            .map(|(items, total_page, total, start, current_page)| {
                tonic::Response::new(proto::ds_alert_plugin_instance::ListDsAlertPluginInstancesResponse {
    ...
    async fn all_alert_plugin_instance(
        ...
        tonic::Response<proto::ds_alert_plugin_instance::AllDsAlertPluginInstancesResponse>,
        tonic::Status,
    > {
        let pool = &self.pool;
        ...
        Ok(tonic::Response::new(
            proto::ds_alert_plugin_instance::AllDsAlertPluginInstancesResponse {
