use crate::{
    ...
    qrtz_triggers::Model as QrtzTriggersModel, t_ds_access_token::Model as DsAccessTokenModel,
    ...
    t_ds_alertgroup::Model as DsAlertgroupModel, t_ds_audit_log::Model as DsAuditLogModel,
    t_ds_command::Model as DsCommandModel, t_ds_datasource::Model as DsDatasourceModel,
    ...
    t_ds_resources::Model as DsResourcesModel, t_ds_schedules::Model as DsSchedulesModel,
    t_ds_session::Model as DsSessionModel, t_ds_task_definition::Model as DsTaskDefinitionModel,
    ...
    t_ds_udfs::Model as DsUdfsModel, t_ds_user::Model as DsUserModel,
    t_ds_version::Model as DsVersionModel, t_ds_worker_group::Model as DsWorkerGroupModel,
};

use proto::{
    ds_access_token::DsAccessToken, ds_alert::DsAlert,
    ds_alert_plugin_instance::DsAlertPluginInstance, ds_alert_send_status::DsAlertSendStatus,
    ds_alertgroup::DsAlertGroup, ds_audit_log::DsAuditLog, ds_command::DsCommand,
    ds_datasource::DsDatasource, ds_dq_comparison_type::DsDqComparisonType,
    ds_dq_execute_result::DsDqExecuteResult, ds_dq_rule::DsDqRule,
    ds_dq_rule_execute_sql::DsDqRuleExecuteSql, ds_dq_rule_input_entry::DsDqRuleInputEntry,
    ds_dq_task_statistics_value::DsDqTaskStatisticsValue, ds_environment::DsEnvironment,
    ...
    ds_relation_rule_input::DsRelationRuleInput, ds_relation_udfs_user::DsRelationUdfsUser,
    ds_resources::DsResource, ds_schedules::DsSchedules, ds_session::DsSession,
    ds_task_definition::DsTaskDefinition, ds_task_definition_log::DsTaskDefinitionLog,
    ds_task_group::DsTaskGroup, ds_task_group_queue::DsTaskGroupQueue,
    ds_task_instance::DsTaskInstance, ds_tenant::DsTenant, ds_udfs::DsUdfs, ds_user::DsUser,
    ds_version::DsVersion, ds_worker_group::DsWorkerGroup, qrtz_blob_triggers::QrtzBlobTrigger,
    qrtz_calendars::QrtzCalendar, qrtz_cron_triggers::QrtzCronTriggers,
    qrtz_fired_triggers::QrtzFiredTriggers, qrtz_job_details::QrtzJobDetails,
    qrtz_locks::QrtzLocks, qrtz_paused_trigger_grps::QrtzPausedTriggerGrps,
    qrtz_scheduler_state::QrtzSchedulerState, qrtz_simple_triggers::QrtzSimpleTrigger,
    qrtz_simprop_triggers::QrtzSimpropTrigger, qrtz_triggers::QrtzTrigger,
};
