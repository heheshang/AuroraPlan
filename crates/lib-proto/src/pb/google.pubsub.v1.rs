...
pub mod schema {
    ...
    pub enum Type {
        ...
        Unspecified = 0,
        /// A lib_protocol Buffer schema definition.
        lib_protocolBuffer = 1,
        /// An Avro schema definition.
        Avro = 2,
    }
    impl Type {
        /// String value of the enum field names used in the lib_protoBuf definition.
        ///
        /// The values are not transformed in any way and thus are considered stable
        /// (if the lib_protoBuf definition does not change) and safe for programmatic use.
        pub fn as_str_name(&self) -> &'static str {
            match self {
                Type::Unspecified => "TYPE_UNSPECIFIED",
                Type::lib_protocolBuffer => "lib_protoCOL_BUFFER",
                Type::Avro => "AVRO",
            }
        }
        /// Creates an enum from field names used in the lib_protoBuf definition.
        pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
            match value {
                "TYPE_UNSPECIFIED" => Some(Self::Unspecified),
                "lib_protoCOL_BUFFER" => Some(Self::lib_protocolBuffer),
                "AVRO" => Some(Self::Avro),
                _ => None,
            }
        }
...
pub mod push_config {
    ...
    /// [OpenID Connect
    /// token](<https://developers.google.com/identity/lib_protocols/OpenIDConnect>).
    #[allow(clippy::derive_partial_eq_without_eq)]
    #[derive(Clone, PartialEq, ::prost::Message)]
