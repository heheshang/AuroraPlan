...
use lib_proto::pb::ds_user::DsUser;
...
pub trait Authenticator: Sync + Send {
    ...
    async fn authenticate(&self, username: String, password: String, extra: String) -> Result<HashMap<String, String>> {
...
impl Authenticator for PasswordAuthenticator {
    async fn login(&self, username: String, password: String, extra: String) -> Result<DsUser> {
        info!("username:{},password:{},extra:{}", username, password, extra);
