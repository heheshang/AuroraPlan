...
use lib_common::utils::code_generate_utils::gen_code;
use lib_proto::ds_project::ds_project_service_server::DsProjectService;
use tracing::info;
...
impl DsProjectService for AuroraRpcServer {
    async fn list_ds_projects(
        &self,
        _req: tonic::Request<lib_proto::ds_project::ListDsProjectsRequest>,
    ) -> std::result::Result<tonic::Response<lib_proto::ds_project::ListDsProjectsResponse>, tonic::Status> {
        let pool = &self.pool;
        ...
        let res = lib_proto::ds_project::ListDsProjectsResponse {
            total: res.2,
            page_size,
    ...
    async fn get_ds_project(
        &self,
        _req: tonic::Request<lib_proto::ds_project::GetDsProjectRequest>,
    ) -> std::result::Result<tonic::Response<lib_proto::ds_project::DsProject>, tonic::Status> {
        todo!()
    }

    async fn create_ds_project(
        &self,
        _req: tonic::Request<lib_proto::ds_project::CreateDsProjectRequest>,
    ) -> std::result::Result<tonic::Response<lib_proto::ds_project::DsProject>, tonic::Status> {
        let pool = &self.pool;
    ...
    async fn update_ds_project(
        &self,
        _req: tonic::Request<lib_proto::ds_project::UpdateDsProjectRequest>,
    ) -> std::result::Result<tonic::Response<lib_proto::ds_project::DsProject>, tonic::Status> {
        let pool = &self.pool;
    ...
    async fn delete_ds_project(
        &self,
        _req: tonic::Request<lib_proto::ds_project::DeleteDsProjectRequest>,
