...
impl DsQueueService for AuroraRpcServer {
    async fn list_ds_queues(
        &self,
        _req: tonic::Request<lib_proto::ds_queue::ListDsQueuesRequest>,
    ) -> std::result::Result<tonic::Response<lib_proto::ds_queue::ListDsQueuesResponse>, tonic::Status> {
        info!("request: {:?}", _req);
        let pool = &self.pool;
        ...
        Model::page(&search_val, page_num, page_size, pool)
            ...
            .map(|(items, total_page, total, start, cur_page)| {
                let res = lib_proto::ds_queue::ListDsQueuesResponse {
                    total,
                    page_size,
    ...
    async fn get_ds_queue(
        &self,
        _req: tonic::Request<lib_proto::ds_queue::GetDsQueueRequest>,
    ) -> std::result::Result<tonic::Response<lib_proto::ds_queue::DsQueue>, tonic::Status> {
        let pool = &self.pool;
    ...
    async fn create_ds_queue(
        &self,
        _req: tonic::Request<lib_proto::ds_queue::CreateDsQueueRequest>,
    ) -> std::result::Result<tonic::Response<lib_proto::ds_queue::DsQueue>, tonic::Status> {
        let pool = &self.pool;
        let queue = _req.get_ref().clone().queue;
    ...
    async fn update_ds_queue(
        &self,
        _req: tonic::Request<lib_proto::ds_queue::UpdateDsQueueRequest>,
    ) -> std::result::Result<tonic::Response<lib_proto::ds_queue::DsQueue>, tonic::Status> {
        let pool = &self.pool;
    ...
    async fn delete_ds_queue(
        &self,
        _req: tonic::Request<lib_proto::ds_queue::DeleteDsQueueRequest>,
    ...
    async fn verify_ds_queue(
        &self,
        request: tonic::Request<lib_proto::ds_queue::VerifyQueueRequest>,
    ) -> std::result::Result<tonic::Response<lib_proto::ds_queue::VerifyQueue>, tonic::Status> {
        ...
        Ok(tonic::Response::new(lib_proto::ds_queue::VerifyQueue {
            ds_queue: Some(lib_proto::ds_queue::DsQueue {
                id: 0,
                queue: Some(queue),
    ...
    ) -> std::result::Result<tonic::Response<lib_proto::ds_queue::AllDsQueuesResponse>, tonic::Status> {
        let pool = &self.pool;
        Model::all(pool)
            .await
            .map(|v| {
                tonic::Response::new(lib_proto::ds_queue::AllDsQueuesResponse {
