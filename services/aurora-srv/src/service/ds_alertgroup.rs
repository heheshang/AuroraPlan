...
impl DsAlertGroupService for AuroraRpcServer {
    async fn list_ds_alert_groups(
        &self,
        _req: tonic::Request<lib_proto::ds_alertgroup::ListDsAlertGroupsRequest>,
    ) -> std::result::Result<tonic::Response<lib_proto::ds_alertgroup::ListDsAlertGroupsResponse>, tonic::Status> {
        let pool = &self.pool;
        ...
        Model::page(&search_val, page_num, page_size, pool)
            ...
            .map(|(items, total_page, total, start, current_page)| {
                tonic::Response::new(lib_proto::ds_alertgroup::ListDsAlertGroupsResponse {
    ...
    async fn get_ds_alert_group(
        &self,
        _req: tonic::Request<lib_proto::ds_alertgroup::GetDsAlertGroupRequest>,
    ) -> std::result::Result<tonic::Response<lib_proto::ds_alertgroup::DsAlertGroup>, tonic::Status> {
        todo!()
    }

    async fn create_ds_alert_group(
        &self,
        _req: tonic::Request<lib_proto::ds_alertgroup::CreateDsAlertGroupRequest>,
    ) -> std::result::Result<tonic::Response<lib_proto::ds_alertgroup::DsAlertGroup>, tonic::Status> {
        let pool = &self.pool;
    ...
    async fn update_ds_alert_group(
        &self,
        _req: tonic::Request<lib_proto::ds_alertgroup::UpdateDsAlertGroupRequest>,
    ) -> std::result::Result<tonic::Response<lib_proto::ds_alertgroup::DsAlertGroup>, tonic::Status> {
        let pool = &self.pool;
    ...
    async fn delete_ds_alert_group(
        &self,
        _req: tonic::Request<lib_proto::ds_alertgroup::DeleteDsAlertGroupRequest>,
    ...
    async fn verify_alert_group(
        &self,
        _request: tonic::Request<lib_proto::ds_alertgroup::VerifyAlertGroupRequest>,
    ) -> std::result::Result<tonic::Response<()>, tonic::Status> {
        let pool = &self.pool;
