...
impl DsWorkerGroupService for AuroraRpcServer {
    async fn list_ds_worker_groups(
        &self,
        _req: tonic::Request<lib_proto::ds_worker_group::ListDsWorkerGroupsRequest>,
    ) -> std::result::Result<tonic::Response<lib_proto::ds_worker_group::ListDsWorkerGroupsResponse>, tonic::Status>
    {
        let pool = &self.pool;
        ...
        Model::page(&search_val, page_num, page_size, pool)
            .await
            .map(|v| {
                tonic::Response::new(lib_proto::ds_worker_group::ListDsWorkerGroupsResponse {
                    total: v.2,
                    page_size,
    ...
    async fn get_ds_worker_group(
        &self,
        _req: tonic::Request<lib_proto::ds_worker_group::GetDsWorkerGroupRequest>,
    ) -> std::result::Result<tonic::Response<lib_proto::ds_worker_group::DsWorkerGroup>, tonic::Status> {
        todo!()
    }

    async fn create_ds_worker_group(
        &self,
        _req: tonic::Request<lib_proto::ds_worker_group::CreateDsWorkerGroupRequest>,
    ) -> std::result::Result<tonic::Response<lib_proto::ds_worker_group::DsWorkerGroup>, tonic::Status> {
        let pool = &self.pool;
    ...
    async fn update_ds_worker_group(
        &self,
        _req: tonic::Request<lib_proto::ds_worker_group::UpdateDsWorkerGroupRequest>,
    ) -> std::result::Result<tonic::Response<lib_proto::ds_worker_group::DsWorkerGroup>, tonic::Status> {
        let pool = &self.pool;
    ...
    async fn delete_ds_worker_group(
        &self,
        _req: tonic::Request<lib_proto::ds_worker_group::DeleteDsWorkerGroupRequest>,
    ...
    ) -> std::result::Result<tonic::Response<lib_proto::ds_worker_group::AllDsWorkerGroupsResponse>, tonic::Status>
    {
        let pool = &self.pool;
        Model::all(pool)
            .await
            .map(|v| {
                tonic::Response::new(lib_proto::ds_worker_group::AllDsWorkerGroupsResponse {
