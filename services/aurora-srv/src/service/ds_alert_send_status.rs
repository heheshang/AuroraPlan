use lib_common::core_results::results::GrpcRequest;
use lib_proto::ds_alert_send_status::{
...
impl DsAlertSendStatusService for AuroraRpcServer {
    async fn list_ds_alert_send_status(
        ...
        tonic::Response<lib_proto::ds_alert_send_status::ListDsAlertSendStatusResponse>,
        tonic::Status,
    > {
        todo!()
    }
    ...
    ) -> std::result::Result<tonic::Response<lib_proto::ds_alert_send_status::DsAlertSendStatus>, tonic::Status> {
        todo!()
    }
