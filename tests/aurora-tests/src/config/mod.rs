...
mod tests {
    ...
    use lib_conifg::get_api_config_path;
    use lib_conifg::get_dao_config_path;
    use std::env;
    ...
    fn dao_config_is_work() {
        ...
        let s = Config::builder()
            ...
            .add_source(File::with_name(config_path.join("default.toml").to_str().unwrap()))
        ...
        let config = s.try_deserialize::<lib_conifg::dao_config::Settings>();
    ...
    fn api_config_is_work() {
        ...
        // You can deserialize (and thus freeze) the entire configuration as
        let config = s.try_deserialize::<lib_conifg::api_config::Settings>();
        println!("config{:?}", config);
    }
}
