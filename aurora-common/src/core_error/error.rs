...
pub enum Error {
    ...
    QueryParentProcessInstanceDetailInfoBySubProcessInstanceIdError(
        AuroraData,
        Option<Vec<String>>,
    ...
    SwitchProcessDefinitionVersionNotExistProcessDefinitionVersionError(
        AuroraData,
        Option<Vec<String>>,
        ...
        match self {
            ...
            Error::InternalServerErrorArgs(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::InternalServerErrorArgs(data.clone(), _param.clone()).into();
                write!(f, "{}", ss)
            }
            Error::RequestParamsNotValidError(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::RequestParamsNotValidError(data.clone(), _param.clone()).into();
                write!(f, "{}", ss)
            }

            Error::TaskTimeoutParamsError(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::TaskTimeoutParamsError(data.clone(), _param.clone()).into();
                write!(f, "{}", ss)
            }
            ...
            Error::HdfsOperationError(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::HdfsOperationError(data.clone(), _param.clone()).into();
                write!(f, "{}", ss)
            }
            Error::TaskInstanceNotFound(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::TaskInstanceNotFound(data.clone(), _param.clone()).into();
                write!(f, "{}", ss)
            }
            Error::OsTenantCodeExist(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::OsTenantCodeExist(data.clone(), _param.clone()).into();
                write!(f, "{}", ss)
            }
            ...
            Error::AlertGroupNotExist(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::AlertGroupNotExist(data.clone(), _param.clone()).into();
                write!(f, "{}", ss)
            }
            Error::AlertGroupExist(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::AlertGroupExist(data.clone(), _param.clone()).into();
                write!(f, "{}", ss)
            }
            Error::UserNamePasswdError(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::UserNamePasswdError(data.clone(), _param.clone()).into();
                write!(f, "{}", ss)
            }
            Error::LoginSessionFailed(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::LoginSessionFailed(data.clone(), _param.clone()).into();
                write!(f, "{}", ss)
            }
            Error::DatasourceExist(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::DatasourceExist(data.clone(), _param.clone()).into();
                write!(f, "{}", ss)
            }
            Error::DatasourceConnectFailed(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::DatasourceConnectFailed(data.clone(), _param.clone()).into();
                write!(f, "{}", ss)
            }
            Error::TenantNotExist(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::TenantNotExist(data.clone(), _param.clone()).into();
                write!(f, "{}", ss)
            }
            Error::ProjectNotFound(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::ProjectNotFound(data.clone(), _param.clone()).into();
                write!(f, "{}", ss)
            }
            Error::ProjectAlreadyExists(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::ProjectAlreadyExists(data.clone(), _param.clone()).into();
                write!(f, "{}", ss)
            }
            Error::TaskInstanceNotExists(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::TaskInstanceNotExists(data.clone(), _param.clone()).into();
                write!(f, "{}", ss)
            }
            ...
            Error::ScheduleCronNotExists(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::ScheduleCronNotExists(data.clone(), _param.clone()).into();
                write!(f, "{}", ss)
            }
            Error::ScheduleCronOnlineForbidUpdate(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::ScheduleCronOnlineForbidUpdate(data.clone(), _param.clone()).into();
                write!(f, "{}", ss)
            }
            Error::ScheduleCronCheckFailed(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::ScheduleCronCheckFailed(data.clone(), _param.clone()).into();
                write!(f, "{}", ss)
            }
            Error::MasterNotExists(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::MasterNotExists(data.clone(), _param.clone()).into();
                write!(f, "{}", ss)
            }
            Error::ScheduleStatusUnknown(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::ScheduleStatusUnknown(data.clone(), _param.clone()).into();
                write!(f, "{}", ss)
            }
            Error::CreateAlertGroupError(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::CreateAlertGroupError(data.clone(), _param.clone()).into();
                write!(f, "{}", ss)
            }
            Error::QueryAllAlertgroupError(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::QueryAllAlertgroupError(data.clone(), _param.clone()).into();
                write!(f, "{}", ss)
            }
            Error::ListPagingAlertGroupError(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::ListPagingAlertGroupError(data.clone(), _param.clone()).into();
                write!(f, "{}", ss)
            }
            Error::UpdateAlertGroupError(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::UpdateAlertGroupError(data.clone(), _param.clone()).into();
                write!(f, "{}", ss)
            }
            Error::DeleteAlertGroupError(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::DeleteAlertGroupError(data.clone(), _param.clone()).into();
                write!(f, "{}", ss)
            }
            Error::AlertGroupGrantUserError(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::AlertGroupGrantUserError(data.clone(), _param.clone()).into();
                write!(f, "{}", ss)
            }
            Error::CreateDatasourceError(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::CreateDatasourceError(data.clone(), _param.clone()).into();
                write!(f, "{}", ss)
            }
            Error::UpdateDatasourceError(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::UpdateDatasourceError(data.clone(), _param.clone()).into();
                write!(f, "{}", ss)
            }
            Error::QueryDatasourceError(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::QueryDatasourceError(data.clone(), _param.clone()).into();
                write!(f, "{}", ss)
            }
            Error::ConnectDatasourceFailure(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::ConnectDatasourceFailure(data.clone(), _param.clone()).into();
                write!(f, "{}", ss)
            }
            Error::ConnectionTestFailure(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::ConnectionTestFailure(data.clone(), _param.clone()).into();
                write!(f, "{}", ss)
            }
            Error::DeleteDataSourceFailure(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::DeleteDataSourceFailure(data.clone(), _param.clone()).into();
                write!(f, "{}", ss)
            }
            Error::VerifyDatasourceNameFailure(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::VerifyDatasourceNameFailure(data.clone(), _param.clone()).into();
                write!(f, "{}", ss)
            }
            Error::UnauthorizedDatasource(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::UnauthorizedDatasource(data.clone(), _param.clone()).into();
                write!(f, "{}", ss)
            }
            Error::AuthorizedDataSource(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::AuthorizedDataSource(data.clone(), _param.clone()).into();
                write!(f, "{}", ss)
            }
            ...
            Error::UserLoginFailure(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::UserLoginFailure(data.clone(), _param.clone()).into();
                write!(f, "{}", ss)
            }
            Error::ListWorkersError(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::ListWorkersError(data.clone(), _param.clone()).into();
                write!(f, "{}", ss)
            }
            Error::ListMastersError(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::ListMastersError(data.clone(), _param.clone()).into();
                write!(f, "{}", ss)
            }
            Error::UpdateProjectError(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::UpdateProjectError(data.clone(), _param.clone()).into();
                write!(f, "{}", ss)
            }
            Error::QueryProjectDetailsByCodeError(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::QueryProjectDetailsByCodeError(data.clone(), _param.clone()).into();
                write!(f, "{}", ss)
            }
            Error::CreateProjectError(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::CreateProjectError(data.clone(), _param.clone()).into();
                write!(f, "{}", ss)
            }
            Error::LoginUserQueryProjectListPagingError(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::LoginUserQueryProjectListPagingError(data.clone(), _param.clone())
                        .into();
                write!(f, "{}", ss)
            }
            Error::DeleteProjectError(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::DeleteProjectError(data.clone(), _param.clone()).into();
                write!(f, "{}", ss)
            }
            Error::QueryUnauthorizedProjectError(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::QueryUnauthorizedProjectError(data.clone(), _param.clone()).into();
                write!(f, "{}", ss)
            }
            Error::QueryAuthorizedProject(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::QueryAuthorizedProject(data.clone(), _param.clone()).into();
                write!(f, "{}", ss)
            }
            Error::QueryQueueListError(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::QueryQueueListError(data.clone(), _param.clone()).into();
                write!(f, "{}", ss)
            }
            Error::CreateResourceError(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::CreateResourceError(data.clone(), _param.clone()).into();
                write!(f, "{}", ss)
            }
            Error::UpdateResourceError(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::UpdateResourceError(data.clone(), _param.clone()).into();
                write!(f, "{}", ss)
            }
            Error::QueryResourcesListError(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::QueryResourcesListError(data.clone(), _param.clone()).into();
                write!(f, "{}", ss)
            }
            Error::QueryResourcesListPaging(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::QueryResourcesListPaging(data.clone(), _param.clone()).into();
                write!(f, "{}", ss)
            }
            Error::DeleteResourceError(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::DeleteResourceError(data.clone(), _param.clone()).into();
                write!(f, "{}", ss)
            }
            Error::VerifyResourceByNameAndTypeError(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::VerifyResourceByNameAndTypeError(data.clone(), _param.clone()).into();
                write!(f, "{}", ss)
            }
            Error::ViewResourceFileOnLineError(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::ViewResourceFileOnLineError(data.clone(), _param.clone()).into();
                write!(f, "{}", ss)
            }
            Error::CreateResourceFileOnLineError(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::CreateResourceFileOnLineError(data.clone(), _param.clone()).into();
                write!(f, "{}", ss)
            }
            Error::ResourceFileIsEmpty(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::ResourceFileIsEmpty(data.clone(), _param.clone()).into();
                write!(f, "{}", ss)
            }
            Error::EditResourceFileOnLineError(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::EditResourceFileOnLineError(data.clone(), _param.clone()).into();
                write!(f, "{}", ss)
            }
            Error::DownloadResourceFileError(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::DownloadResourceFileError(data.clone(), _param.clone()).into();
                write!(f, "{}", ss)
            }
            Error::CreateUdfFunctionError(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::CreateUdfFunctionError(data.clone(), _param.clone()).into();
                write!(f, "{}", ss)
            }
            Error::ViewUdfFunctionError(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::ViewUdfFunctionError(data.clone(), _param.clone()).into();
                write!(f, "{}", ss)
            }
            Error::UpdateUdfFunctionError(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::UpdateUdfFunctionError(data.clone(), _param.clone()).into();
                write!(f, "{}", ss)
            }
            Error::QueryUdfFunctionListPagingError(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::QueryUdfFunctionListPagingError(data.clone(), _param.clone()).into();
                write!(f, "{}", ss)
            }
            Error::QueryDatasourceByTypeError(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::QueryDatasourceByTypeError(data.clone(), _param.clone()).into();
                write!(f, "{}", ss)
            }
            Error::VerifyUdfFunctionNameError(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::VerifyUdfFunctionNameError(data.clone(), _param.clone()).into();
                write!(f, "{}", ss)
            }
            Error::DeleteUdfFunctionError(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::DeleteUdfFunctionError(data.clone(), _param.clone()).into();
                write!(f, "{}", ss)
            }
            Error::AuthorizedFileResourceError(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::AuthorizedFileResourceError(data.clone(), _param.clone()).into();
                write!(f, "{}", ss)
            }
            Error::AuthorizeResourceTree(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::AuthorizeResourceTree(data.clone(), _param.clone()).into();
                write!(f, "{}", ss)
            }
            Error::UnauthorizedUdfFunctionError(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::UnauthorizedUdfFunctionError(data.clone(), _param.clone()).into();
                write!(f, "{}", ss)
            }
            Error::AuthorizedUdfFunctionError(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::AuthorizedUdfFunctionError(data.clone(), _param.clone()).into();
                write!(f, "{}", ss)
            }
            Error::CreateScheduleError(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::CreateScheduleError(data.clone(), _param.clone()).into();
                write!(f, "{}", ss)
            }
            Error::UpdateScheduleError(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::UpdateScheduleError(data.clone(), _param.clone()).into();
                write!(f, "{}", ss)
            }
            Error::PublishScheduleOnlineError(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::PublishScheduleOnlineError(data.clone(), _param.clone()).into();
                write!(f, "{}", ss)
            }
            Error::OfflineScheduleError(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::OfflineScheduleError(data.clone(), _param.clone()).into();
                write!(f, "{}", ss)
            }
            Error::QueryScheduleListPagingError(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::QueryScheduleListPagingError(data.clone(), _param.clone()).into();
                write!(f, "{}", ss)
            }
            Error::QueryScheduleListError(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::QueryScheduleListError(data.clone(), _param.clone()).into();
                write!(f, "{}", ss)
            }
            Error::QueryTaskListPagingError(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::QueryTaskListPagingError(data.clone(), _param.clone()).into();
                write!(f, "{}", ss)
            }
            Error::QueryTaskRecordListPagingError(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::QueryTaskRecordListPagingError(data.clone(), _param.clone()).into();
                write!(f, "{}", ss)
            }
            Error::CreateTenantError(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::CreateTenantError(data.clone(), _param.clone()).into();
                write!(f, "{}", ss)
            }
            Error::QueryTenantListPagingError(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::QueryTenantListPagingError(data.clone(), _param.clone()).into();
                write!(f, "{}", ss)
            }
            Error::QueryTenantListError(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::QueryTenantListError(data.clone(), _param.clone()).into();
                write!(f, "{}", ss)
            }
            Error::UpdateTenantError(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::UpdateTenantError(data.clone(), _param.clone()).into();
                write!(f, "{}", ss)
            }
            Error::DeleteTenantByIdError(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::DeleteTenantByIdError(data.clone(), _param.clone()).into();
                write!(f, "{}", ss)
            }
            Error::VerifyOsTenantCodeError(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::VerifyOsTenantCodeError(data.clone(), _param.clone()).into();
                write!(f, "{}", ss)
            }
            Error::CreateUserError(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::CreateUserError(data.clone(), _param.clone()).into();
                write!(f, "{}", ss)
            }
            Error::QueryUserListPagingError(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::QueryUserListPagingError(data.clone(), _param.clone()).into();
                write!(f, "{}", ss)
            }
            Error::UpdateUserError(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::UpdateUserError(data.clone(), _param.clone()).into();
                write!(f, "{}", ss)
            }
            Error::DeleteUserByIdError(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::DeleteUserByIdError(data.clone(), _param.clone()).into();
                write!(f, "{}", ss)
            }
            Error::GrantProjectError(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::GrantProjectError(data.clone(), _param.clone()).into();
                write!(f, "{}", ss)
            }
            Error::GrantResourceError(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::GrantResourceError(data.clone(), _param.clone()).into();
                write!(f, "{}", ss)
            }
            Error::GrantUdfFunctionError(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::GrantUdfFunctionError(data.clone(), _param.clone()).into();
                write!(f, "{}", ss)
            }
            Error::GrantDatasourceError(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::GrantDatasourceError(data.clone(), _param.clone()).into();
                write!(f, "{}", ss)
            }
            Error::GetUserInfoError(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::GetUserInfoError(data.clone(), _param.clone()).into();
                write!(f, "{}", ss)
            }
            ...
            Error::VerifyUsernameError(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::VerifyUsernameError(data.clone(), _param.clone()).into();
                write!(f, "{}", ss)
            }
            Error::UnauthorizedUserError(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::UnauthorizedUserError(data.clone(), _param.clone()).into();
                write!(f, "{}", ss)
            }
            Error::AuthorizedUserError(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::AuthorizedUserError(data.clone(), _param.clone()).into();
                write!(f, "{}", ss)
            }
            Error::QueryTaskInstanceLogError(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::QueryTaskInstanceLogError(data.clone(), _param.clone()).into();
                write!(f, "{}", ss)
            }
            Error::DownloadTaskInstanceLogFileError(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::DownloadTaskInstanceLogFileError(data.clone(), _param.clone()).into();
                write!(f, "{}", ss)
            }
            Error::CreateProcessDefinitionError(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::CreateProcessDefinitionError(data.clone(), _param.clone()).into();
                write!(f, "{}", ss)
            }
            Error::VerifyProcessDefinitionNameUniqueError(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::VerifyProcessDefinitionNameUniqueError(data.clone(), _param.clone())
                        .into();
                write!(f, "{}", ss)
            }
            Error::UpdateProcessDefinitionError(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::UpdateProcessDefinitionError(data.clone(), _param.clone()).into();
                write!(f, "{}", ss)
            }
            Error::ReleaseProcessDefinitionError(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::ReleaseProcessDefinitionError(data.clone(), _param.clone()).into();
                write!(f, "{}", ss)
            }
            ...
            Error::QueryProcessDefinitionList(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::QueryProcessDefinitionList(data.clone(), _param.clone()).into();
                write!(f, "{}", ss)
            }
            ...
            Error::GetTasksListByProcessDefinitionIdError(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::GetTasksListByProcessDefinitionIdError(data.clone(), _param.clone())
                        .into();
                write!(f, "{}", ss)
            }
            ...
            Error::QueryTaskListByProcessInstanceIdError(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::QueryTaskListByProcessInstanceIdError(data.clone(), _param.clone())
                        .into();
                write!(f, "{}", ss)
            }
            Error::UpdateProcessInstanceError(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::UpdateProcessInstanceError(data.clone(), _param.clone()).into();
                write!(f, "{}", ss)
            }
            Error::QueryProcessInstanceByIdError(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::QueryProcessInstanceByIdError(data.clone(), _param.clone()).into();
                write!(f, "{}", ss)
            }
            Error::DeleteProcessInstanceByIdError(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::DeleteProcessInstanceByIdError(data.clone(), _param.clone()).into();
                write!(f, "{}", ss)
            }
            Error::QuerySubProcessInstanceDetailInfoByTaskIdError(data, _param) => {
                let ss: AuroraErrorInfo = Error::QuerySubProcessInstanceDetailInfoByTaskIdError(
                    data.clone(),
                    _param.clone(),
                )
                .into();
            ...
            Error::QueryProcessInstanceAllVariablesError(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::QueryProcessInstanceAllVariablesError(data.clone(), _param.clone())
                        .into();
                write!(f, "{}", ss)
            }
            Error::EncapsulationProcessInstanceGanttStructureError(data, _param) => {
                let ss: AuroraErrorInfo = Error::EncapsulationProcessInstanceGanttStructureError(
                    data.clone(),
                    _param.clone(),
                )
                .into();
            ...
            Error::QueryProcessDefinitionListPagingError(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::QueryProcessDefinitionListPagingError(data.clone(), _param.clone())
                        .into();
                write!(f, "{}", ss)
            }
            ...
            Error::OsTenantCodeHasAlreadyExists(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::OsTenantCodeHasAlreadyExists(data.clone(), _param.clone()).into();
                write!(f, "{}", ss)
            }
            ...
            Error::ScheduleCronReleaseNeedNotChange(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::ScheduleCronReleaseNeedNotChange(data.clone(), _param.clone()).into();
                write!(f, "{}", ss)
            }
            Error::CreateQueueError(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::CreateQueueError(data.clone(), _param.clone()).into();
                write!(f, "{}", ss)
            }
            ...
            Error::QueueValueExist(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::QueueValueExist(data.clone(), _param.clone()).into();
                write!(f, "{}", ss)
            }
            Error::QueueNameExist(data, error_param) => {
                let ss: AuroraErrorInfo =
                    Error::QueueNameExist(data.clone(), error_param.clone()).into();
                write!(f, "{}", ss)
            }
            Error::UpdateQueueError(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::UpdateQueueError(data.clone(), _param.clone()).into();
                write!(f, "{}", ss)
            }
            Error::NeedNotUpdateQueue(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::NeedNotUpdateQueue(data.clone(), _param.clone()).into();
                write!(f, "{}", ss)
            }
            Error::VerifyQueueError(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::VerifyQueueError(data.clone(), _param.clone()).into();
                write!(f, "{}", ss)
            }
            ...
            Error::DeleteProjectErrorDefinesNotNull(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::DeleteProjectErrorDefinesNotNull(data.clone(), _param.clone()).into();
                write!(f, "{}", ss)
            }
            Error::BatchDeleteProcessInstanceByIdsError(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::BatchDeleteProcessInstanceByIdsError(data.clone(), _param.clone())
                        .into();
                write!(f, "{}", ss)
            }
            Error::PreviewScheduleError(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::PreviewScheduleError(data.clone(), _param.clone()).into();
                write!(f, "{}", ss)
            }
            Error::ParseToCronExpressionError(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::ParseToCronExpressionError(data.clone(), _param.clone()).into();
                write!(f, "{}", ss)
            }
            Error::ScheduleStartTimeEndTimeSame(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::ScheduleStartTimeEndTimeSame(data.clone(), _param.clone()).into();
                write!(f, "{}", ss)
            }
            Error::DeleteTenantByIdFail(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::DeleteTenantByIdFail(data.clone(), _param.clone()).into();
                write!(f, "{}", ss)
            }
            Error::DeleteTenantByIdFailDefines(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::DeleteTenantByIdFailDefines(data.clone(), _param.clone()).into();
                write!(f, "{}", ss)
            }
            Error::DeleteTenantByIdFailUsers(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::DeleteTenantByIdFailUsers(data.clone(), _param.clone()).into();
                write!(f, "{}", ss)
            }
            Error::DeleteWorkerGroupByIdFail(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::DeleteWorkerGroupByIdFail(data.clone(), _param.clone()).into();
                write!(f, "{}", ss)
            }
            Error::QueryWorkerGroupFail(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::QueryWorkerGroupFail(data.clone(), _param.clone()).into();
                write!(f, "{}", ss)
            }
            Error::DeleteWorkerGroupFail(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::DeleteWorkerGroupFail(data.clone(), _param.clone()).into();
                write!(f, "{}", ss)
            }
            ...
            Error::CopyProcessDefinitionError(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::CopyProcessDefinitionError(data.clone(), _param.clone()).into();
                write!(f, "{}", ss)
            }
            Error::MoveProcessDefinitionError(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::MoveProcessDefinitionError(data.clone(), _param.clone()).into();
                write!(f, "{}", ss)
            }
            ...
            Error::QueryUserCreatedProjectError(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::QueryUserCreatedProjectError(data.clone(), _param.clone()).into();
                write!(f, "{}", ss)
            }
            Error::ProcessDefinitionCodesIsEmpty(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::ProcessDefinitionCodesIsEmpty(data.clone(), _param.clone()).into();
                write!(f, "{}", ss)
            }
            Error::BatchCopyProcessDefinitionError(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::BatchCopyProcessDefinitionError(data.clone(), _param.clone()).into();
                write!(f, "{}", ss)
            }
            Error::BatchMoveProcessDefinitionError(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::BatchMoveProcessDefinitionError(data.clone(), _param.clone()).into();
                write!(f, "{}", ss)
            }
            Error::QueryWorkflowLineageError(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::QueryWorkflowLineageError(data.clone(), _param.clone()).into();
                write!(f, "{}", ss)
            }
            Error::QueryAuthorizedAndUserCreatedProjectError(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::QueryAuthorizedAndUserCreatedProjectError(data.clone(), _param.clone())
                        .into();
                write!(f, "{}", ss)
            }
            Error::DeleteProcessDefinitionByCodeFail(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::DeleteProcessDefinitionByCodeFail(data.clone(), _param.clone()).into();
                write!(f, "{}", ss)
            }
            Error::CheckOsTenantCodeError(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::CheckOsTenantCodeError(data.clone(), _param.clone()).into();
                write!(f, "{}", ss)
            }
            Error::ForceTaskSuccessError(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::ForceTaskSuccessError(data.clone(), _param.clone()).into();
                write!(f, "{}", ss)
            }
            Error::TaskInstanceStateOperationError(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::TaskInstanceStateOperationError(data.clone(), _param.clone()).into();
                write!(f, "{}", ss)
            }
            Error::DatasourceTypeNotExist(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::DatasourceTypeNotExist(data.clone(), _param.clone()).into();
                write!(f, "{}", ss)
            }
            Error::ProcessDefinitionNameExist(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::ProcessDefinitionNameExist(data.clone(), _param.clone()).into();
                write!(f, "{}", ss)
            }
            Error::DatasourceDbTypeIllegal(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::DatasourceDbTypeIllegal(data.clone(), _param.clone()).into();
                write!(f, "{}", ss)
            }
            Error::DatasourcePortIllegal(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::DatasourcePortIllegal(data.clone(), _param.clone()).into();
                write!(f, "{}", ss)
            }
            Error::DatasourceOtherParamsIllegal(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::DatasourceOtherParamsIllegal(data.clone(), _param.clone()).into();
                write!(f, "{}", ss)
            }
            Error::DatasourceNameIllegal(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::DatasourceNameIllegal(data.clone(), _param.clone()).into();
                write!(f, "{}", ss)
            }
            Error::DatasourceHostIllegal(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::DatasourceHostIllegal(data.clone(), _param.clone()).into();
                write!(f, "{}", ss)
            }
            Error::DeleteWorkerGroupNotExist(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::DeleteWorkerGroupNotExist(data.clone(), _param.clone()).into();
                write!(f, "{}", ss)
            }
            ...
            Error::WorkerAddressInvalid(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::WorkerAddressInvalid(data.clone(), _param.clone()).into();
                write!(f, "{}", ss)
            }
            Error::QueryWorkerAddressListFail(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::QueryWorkerAddressListFail(data.clone(), _param.clone()).into();
                write!(f, "{}", ss)
            }
            Error::TransformProjectOwnership(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::TransformProjectOwnership(data.clone(), _param.clone()).into();
                write!(f, "{}", ss)
            }
            Error::QueryAlertGroupError(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::QueryAlertGroupError(data.clone(), _param.clone()).into();
                write!(f, "{}", ss)
            }
            Error::CurrentLoginUserTenantNotExist(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::CurrentLoginUserTenantNotExist(data.clone(), _param.clone()).into();
                write!(f, "{}", ss)
            }
            Error::RevokeProjectError(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::RevokeProjectError(data.clone(), _param.clone()).into();
                write!(f, "{}", ss)
            }
            Error::QueryAuthorizedUser(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::QueryAuthorizedUser(data.clone(), _param.clone()).into();
                write!(f, "{}", ss)
            }
            Error::ProjectNotExist(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::ProjectNotExist(data.clone(), _param.clone()).into();
                write!(f, "{}", ss)
            }
            Error::TaskInstanceHostIsNull(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::TaskInstanceHostIsNull(data.clone(), _param.clone()).into();
                write!(f, "{}", ss)
            }
            Error::QueryExecutingWorkflowError(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::QueryExecutingWorkflowError(data.clone(), _param.clone()).into();
                write!(f, "{}", ss)
            }
            Error::UdfFunctionNotExist(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::UdfFunctionNotExist(data.clone(), _param.clone()).into();
                write!(f, "{}", ss)
            }
            Error::UdfFunctionExists(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::UdfFunctionExists(data.clone(), _param.clone()).into();
                write!(f, "{}", ss)
            }
            Error::ResourceNotExist(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::ResourceNotExist(data.clone(), _param.clone()).into();
                write!(f, "{}", ss)
            }
            ...
            Error::ResourceSuffixNotSupportView(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::ResourceSuffixNotSupportView(data.clone(), _param.clone()).into();
                write!(f, "{}", ss)
            }
            Error::ResourceSizeExceedLimit(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::ResourceSizeExceedLimit(data.clone(), _param.clone()).into();
                write!(f, "{}", ss)
            }
            Error::ResourceSuffixForbidChange(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::ResourceSuffixForbidChange(data.clone(), _param.clone()).into();
                write!(f, "{}", ss)
            }
            Error::UdfResourceSuffixNotJar(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::UdfResourceSuffixNotJar(data.clone(), _param.clone()).into();
                write!(f, "{}", ss)
            }
            ...
            Error::ResourceFileExist(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::ResourceFileExist(data.clone(), _param.clone()).into();
                write!(f, "{}", ss)
            }
            Error::ResourceFileNotExist(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::ResourceFileNotExist(data.clone(), _param.clone()).into();
                write!(f, "{}", ss)
            }
            Error::UdfResourceIsBound(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::UdfResourceIsBound(data.clone(), _param.clone()).into();
                write!(f, "{}", ss)
            }
            Error::ResourceIsUsed(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::ResourceIsUsed(data.clone(), _param.clone()).into();
                write!(f, "{}", ss)
            }
            Error::ParentResourceNotExist(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::ParentResourceNotExist(data.clone(), _param.clone()).into();
                write!(f, "{}", ss)
            }
            Error::ResourceNotExistOrNoPermission(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::ResourceNotExistOrNoPermission(data.clone(), _param.clone()).into();
                write!(f, "{}", ss)
            }
            Error::ResourceIsAuthorized(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::ResourceIsAuthorized(data.clone(), _param.clone()).into();
                write!(f, "{}", ss)
            }
            Error::UserNoOperationPerm(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::UserNoOperationPerm(data.clone(), _param.clone()).into();
                write!(f, "{}", ss)
            }
            Error::UserNoOperationProjectPerm(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::UserNoOperationProjectPerm(data.clone(), _param.clone()).into();
                write!(f, "{}", ss)
            }
            Error::ProcessInstanceNotExist(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::ProcessInstanceNotExist(data.clone(), _param.clone()).into();
                write!(f, "{}", ss)
            }
            Error::ProcessInstanceExist(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::ProcessInstanceExist(data.clone(), _param.clone()).into();
                write!(f, "{}", ss)
            }
            Error::ProcessDefineNotExist(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::ProcessDefineNotExist(data.clone(), _param.clone()).into();
                write!(f, "{}", ss)
            }
            Error::ProcessDefineNotRelease(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::ProcessDefineNotRelease(data.clone(), _param.clone()).into();
                write!(f, "{}", ss)
            }
            Error::SubProcessDefineNotRelease(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::SubProcessDefineNotRelease(data.clone(), _param.clone()).into();
                write!(f, "{}", ss)
            }
            Error::ProcessInstanceAlreadyChanged(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::ProcessInstanceAlreadyChanged(data.clone(), _param.clone()).into();
                write!(f, "{}", ss)
            }
            ...
            Error::SubProcessInstanceNotExist(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::SubProcessInstanceNotExist(data.clone(), _param.clone()).into();
                write!(f, "{}", ss)
            }
            Error::ProcessDefineNotAllowedEdit(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::ProcessDefineNotAllowedEdit(data.clone(), _param.clone()).into();
                write!(f, "{}", ss)
            }
            Error::ProcessInstanceExecutingCommand(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::ProcessInstanceExecutingCommand(data.clone(), _param.clone()).into();
                write!(f, "{}", ss)
            }
            Error::ProcessInstanceNotSubProcessInstance(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::ProcessInstanceNotSubProcessInstance(data.clone(), _param.clone())
                        .into();
                write!(f, "{}", ss)
            }
            Error::TaskInstanceStateCountError(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::TaskInstanceStateCountError(data.clone(), _param.clone()).into();
                write!(f, "{}", ss)
            }
            Error::CountProcessInstanceStateError(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::CountProcessInstanceStateError(data.clone(), _param.clone()).into();
                write!(f, "{}", ss)
            }
            Error::CountProcessDefinitionUserError(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::CountProcessDefinitionUserError(data.clone(), _param.clone()).into();
                write!(f, "{}", ss)
            }
            Error::StartProcessInstanceError(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::StartProcessInstanceError(data.clone(), _param.clone()).into();
                write!(f, "{}", ss)
            }
            Error::BatchStartProcessInstanceError(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::BatchStartProcessInstanceError(data.clone(), _param.clone()).into();
                write!(f, "{}", ss)
            }
            Error::ProcessInstanceError(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::ProcessInstanceError(data.clone(), _param.clone()).into();
                write!(f, "{}", ss)
            }
            Error::ExecuteProcessInstanceError(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::ExecuteProcessInstanceError(data.clone(), _param.clone()).into();
                write!(f, "{}", ss)
            }
            Error::CheckProcessDefinitionError(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::CheckProcessDefinitionError(data.clone(), _param.clone()).into();
                write!(f, "{}", ss)
            }
            Error::QueryRecipientsAndCopyersByProcessDefinitionError(data, _param) => {
                let ss: AuroraErrorInfo = Error::QueryRecipientsAndCopyersByProcessDefinitionError(
                    data.clone(),
                    _param.clone(),
                )
                .into();
            ...
            Error::DataIsNotValid(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::DataIsNotValid(data.clone(), _param.clone()).into();
                write!(f, "{}", ss)
            }
            ...
            Error::ProcessNodeHasCycle(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::ProcessNodeHasCycle(data.clone(), _param.clone()).into();
                write!(f, "{}", ss)
            }
            Error::ProcessNodeSParameterInvalid(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::ProcessNodeSParameterInvalid(data.clone(), _param.clone()).into();
                write!(f, "{}", ss)
            }
            Error::ProcessDefineStateOnline(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::ProcessDefineStateOnline(data.clone(), _param.clone()).into();
                write!(f, "{}", ss)
            }
            Error::DeleteProcessDefineByCodeError(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::DeleteProcessDefineByCodeError(data.clone(), _param.clone()).into();
                write!(f, "{}", ss)
            }
            Error::ScheduleCronStateOnline(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::ScheduleCronStateOnline(data.clone(), _param.clone()).into();
                write!(f, "{}", ss)
            }
            Error::DeleteScheduleCronByIdError(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::DeleteScheduleCronByIdError(data.clone(), _param.clone()).into();
                write!(f, "{}", ss)
            }
            Error::BatchDeleteProcessDefineError(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::BatchDeleteProcessDefineError(data.clone(), _param.clone()).into();
                write!(f, "{}", ss)
            }
            Error::BatchDeleteProcessDefineByCodesError(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::BatchDeleteProcessDefineByCodesError(data.clone(), _param.clone())
                        .into();
                write!(f, "{}", ss)
            }
            Error::DeleteProcessDefineByCodesError(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::DeleteProcessDefineByCodesError(data.clone(), _param.clone()).into();
                write!(f, "{}", ss)
            }
            Error::TenantNotSuitable(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::TenantNotSuitable(data.clone(), _param.clone()).into();
                write!(f, "{}", ss)
            }
            Error::ExportProcessDefineByIdError(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::ExportProcessDefineByIdError(data.clone(), _param.clone()).into();
                write!(f, "{}", ss)
            }
            ...
            Error::ImportProcessDefineError(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::ImportProcessDefineError(data.clone(), _param.clone()).into();
                write!(f, "{}", ss)
            }
            ...
            Error::CreateProcessTaskRelationError(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::CreateProcessTaskRelationError(data.clone(), _param.clone()).into();
                write!(f, "{}", ss)
            }
            Error::ProcessTaskRelationNotExist(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::ProcessTaskRelationNotExist(data.clone(), _param.clone()).into();
                write!(f, "{}", ss)
            }
            Error::ProcessTaskRelationExist(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::ProcessTaskRelationExist(data.clone(), _param.clone()).into();
                write!(f, "{}", ss)
            }
            Error::ProcessDagIsEmpty(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::ProcessDagIsEmpty(data.clone(), _param.clone()).into();
                write!(f, "{}", ss)
            }
            Error::CheckProcessTaskRelationError(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::CheckProcessTaskRelationError(data.clone(), _param.clone()).into();
                write!(f, "{}", ss)
            }
            Error::CreateTaskDefinitionError(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::CreateTaskDefinitionError(data.clone(), _param.clone()).into();
                write!(f, "{}", ss)
            }
            Error::UpdateTaskDefinitionError(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::UpdateTaskDefinitionError(data.clone(), _param.clone()).into();
                write!(f, "{}", ss)
            }
            Error::QueryTaskDefinitionVersionsError(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::QueryTaskDefinitionVersionsError(data.clone(), _param.clone()).into();
                write!(f, "{}", ss)
            }
            Error::SwitchTaskDefinitionVersionError(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::SwitchTaskDefinitionVersionError(data.clone(), _param.clone()).into();
                write!(f, "{}", ss)
            }
            Error::DeleteTaskDefinitionVersionError(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::DeleteTaskDefinitionVersionError(data.clone(), _param.clone()).into();
                write!(f, "{}", ss)
            }
            Error::DeleteTaskDefineByCodeError(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::DeleteTaskDefineByCodeError(data.clone(), _param.clone()).into();
                write!(f, "{}", ss)
            }
            Error::QueryDetailOfTaskDefinitionError(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::QueryDetailOfTaskDefinitionError(data.clone(), _param.clone()).into();
                write!(f, "{}", ss)
            }
            ...
            Error::TaskDefinitionNameExisted(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::TaskDefinitionNameExisted(data.clone(), _param.clone()).into();
                write!(f, "{}", ss)
            }
            Error::ReleaseTaskDefinitionError(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::ReleaseTaskDefinitionError(data.clone(), _param.clone()).into();
                write!(f, "{}", ss)
            }
            Error::MoveProcessTaskRelationError(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::MoveProcessTaskRelationError(data.clone(), _param.clone()).into();
                write!(f, "{}", ss)
            }
            Error::DeleteTaskProcessRelationError(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::DeleteTaskProcessRelationError(data.clone(), _param.clone()).into();
                write!(f, "{}", ss)
            }
            Error::QueryTaskProcessRelationError(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::QueryTaskProcessRelationError(data.clone(), _param.clone()).into();
                write!(f, "{}", ss)
            }
            Error::TaskDefineStateOnline(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::TaskDefineStateOnline(data.clone(), _param.clone()).into();
                write!(f, "{}", ss)
            }
            Error::TaskHasDownstream(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::TaskHasDownstream(data.clone(), _param.clone()).into();
                write!(f, "{}", ss)
            }
            Error::TaskHasUpstream(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::TaskHasUpstream(data.clone(), _param.clone()).into();
                write!(f, "{}", ss)
            }
            Error::MainTableUsingVersion(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::MainTableUsingVersion(data.clone(), _param.clone()).into();
                write!(f, "{}", ss)
            }
            Error::ProjectProcessNotMatch(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::ProjectProcessNotMatch(data.clone(), _param.clone()).into();
                write!(f, "{}", ss)
            }
            Error::DeleteEdgeError(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::DeleteEdgeError(data.clone(), _param.clone()).into();
                write!(f, "{}", ss)
            }
            Error::NotSupportUpdateTaskDefinition(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::NotSupportUpdateTaskDefinition(data.clone(), _param.clone()).into();
                write!(f, "{}", ss)
            }
            Error::NotSupportCopyTaskType(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::NotSupportCopyTaskType(data.clone(), _param.clone()).into();
                write!(f, "{}", ss)
            }
            Error::HdfsNotStartup(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::HdfsNotStartup(data.clone(), _param.clone()).into();
                write!(f, "{}", ss)
            }
            Error::StorageNotStartup(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::StorageNotStartup(data.clone(), _param.clone()).into();
                write!(f, "{}", ss)
            }
            Error::S3CannotRename(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::S3CannotRename(data.clone(), _param.clone()).into();
                write!(f, "{}", ss)
            }
            Error::QueryDatabaseStateError(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::QueryDatabaseStateError(data.clone(), _param.clone()).into();
                write!(f, "{}", ss)
            }
            Error::CreateAccessTokenError(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::CreateAccessTokenError(data.clone(), _param.clone()).into();
                write!(f, "{}", ss)
            }
            Error::GenerateTokenError(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::GenerateTokenError(data.clone(), _param.clone()).into();
                write!(f, "{}", ss)
            }
            Error::QueryAccesstokenListPagingError(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::QueryAccesstokenListPagingError(data.clone(), _param.clone()).into();
                write!(f, "{}", ss)
            }
            Error::UpdateAccessTokenError(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::UpdateAccessTokenError(data.clone(), _param.clone()).into();
                write!(f, "{}", ss)
            }
            Error::DeleteAccessTokenError(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::DeleteAccessTokenError(data.clone(), _param.clone()).into();
                write!(f, "{}", ss)
            }
            Error::AccessTokenNotExist(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::AccessTokenNotExist(data.clone(), _param.clone()).into();
                write!(f, "{}", ss)
            }
            Error::QueryAccesstokenByUserError(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::QueryAccesstokenByUserError(data.clone(), _param.clone()).into();
                write!(f, "{}", ss)
            }
            Error::CommandStateCountError(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::CommandStateCountError(data.clone(), _param.clone()).into();
                write!(f, "{}", ss)
            }
            Error::NegativeSizeNumberError(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::NegativeSizeNumberError(data.clone(), _param.clone()).into();
                write!(f, "{}", ss)
            }
            Error::StartTimeBiggerThanEndTimeError(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::StartTimeBiggerThanEndTimeError(data.clone(), _param.clone()).into();
                write!(f, "{}", ss)
            }
            Error::QueueCountError(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::QueueCountError(data.clone(), _param.clone()).into();
                write!(f, "{}", ss)
            }
            Error::KerberosStartupState(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::KerberosStartupState(data.clone(), _param.clone()).into();
                write!(f, "{}", ss)
            }
            Error::QueryAuditLogListPaging(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::QueryAuditLogListPaging(data.clone(), _param.clone()).into();
                write!(f, "{}", ss)
            }
            Error::PluginNotAUiComponent(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::PluginNotAUiComponent(data.clone(), _param.clone()).into();
                write!(f, "{}", ss)
            }
            Error::QueryPluginsResultIsNull(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::QueryPluginsResultIsNull(data.clone(), _param.clone()).into();
                write!(f, "{}", ss)
            }
            Error::QueryPluginsError(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::QueryPluginsError(data.clone(), _param.clone()).into();
                write!(f, "{}", ss)
            }
            Error::QueryPluginDetailResultIsNull(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::QueryPluginDetailResultIsNull(data.clone(), _param.clone()).into();
                write!(f, "{}", ss)
            }
            Error::UpdateAlertPluginInstanceError(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::UpdateAlertPluginInstanceError(data.clone(), _param.clone()).into();
                write!(f, "{}", ss)
            }
            Error::DeleteAlertPluginInstanceError(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::DeleteAlertPluginInstanceError(data.clone(), _param.clone()).into();
                write!(f, "{}", ss)
            }
            Error::GetAlertPluginInstanceError(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::GetAlertPluginInstanceError(data.clone(), _param.clone()).into();
                write!(f, "{}", ss)
            }
            Error::CreateAlertPluginInstanceError(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::CreateAlertPluginInstanceError(data.clone(), _param.clone()).into();
                write!(f, "{}", ss)
            }
            Error::QueryAllAlertPluginInstanceError(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::QueryAllAlertPluginInstanceError(data.clone(), _param.clone()).into();
                write!(f, "{}", ss)
            }
            Error::PluginInstanceAlreadyExit(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::PluginInstanceAlreadyExit(data.clone(), _param.clone()).into();
                write!(f, "{}", ss)
            }
            ...
            Error::ProcessDefinitionVersionIsUsed(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::ProcessDefinitionVersionIsUsed(data.clone(), _param.clone()).into();
                write!(f, "{}", ss)
            }
            Error::CreateEnvironmentError(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::CreateEnvironmentError(data.clone(), _param.clone()).into();
                write!(f, "{}", ss)
            }
            Error::EnvironmentNameExists(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::EnvironmentNameExists(data.clone(), _param.clone()).into();
                write!(f, "{}", ss)
            }
            Error::EnvironmentNameIsNull(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::EnvironmentNameIsNull(data.clone(), _param.clone()).into();
                write!(f, "{}", ss)
            }
            Error::EnvironmentConfigIsNull(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::EnvironmentConfigIsNull(data.clone(), _param.clone()).into();
                write!(f, "{}", ss)
            }
            Error::UpdateEnvironmentError(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::UpdateEnvironmentError(data.clone(), _param.clone()).into();
                write!(f, "{}", ss)
            }
            Error::DeleteEnvironmentError(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::DeleteEnvironmentError(data.clone(), _param.clone()).into();
                write!(f, "{}", ss)
            }
            ...
            Error::QueryEnvironmentByNameError(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::QueryEnvironmentByNameError(data.clone(), _param.clone()).into();
                write!(f, "{}", ss)
            }
            Error::QueryEnvironmentByCodeError(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::QueryEnvironmentByCodeError(data.clone(), _param.clone()).into();
                write!(f, "{}", ss)
            }
            Error::QueryEnvironmentError(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::QueryEnvironmentError(data.clone(), _param.clone()).into();
                write!(f, "{}", ss)
            }
            Error::VerifyEnvironmentError(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::VerifyEnvironmentError(data.clone(), _param.clone()).into();
                write!(f, "{}", ss)
            }
            Error::GetRuleFormCreateJsonError(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::GetRuleFormCreateJsonError(data.clone(), _param.clone()).into();
                write!(f, "{}", ss)
            }
            Error::QueryRuleListPagingError(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::QueryRuleListPagingError(data.clone(), _param.clone()).into();
                write!(f, "{}", ss)
            }
            Error::QueryRuleListError(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::QueryRuleListError(data.clone(), _param.clone()).into();
                write!(f, "{}", ss)
            }
            Error::QueryRuleInputEntryListError(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::QueryRuleInputEntryListError(data.clone(), _param.clone()).into();
                write!(f, "{}", ss)
            }
            Error::QueryExecuteResultListPagingError(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::QueryExecuteResultListPagingError(data.clone(), _param.clone()).into();
                write!(f, "{}", ss)
            }
            Error::GetDatasourceOptionsError(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::GetDatasourceOptionsError(data.clone(), _param.clone()).into();
                write!(f, "{}", ss)
            }
            Error::GetDatasourceTablesError(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::GetDatasourceTablesError(data.clone(), _param.clone()).into();
                write!(f, "{}", ss)
            }
            Error::GetDatasourceTableColumnsError(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::GetDatasourceTableColumnsError(data.clone(), _param.clone()).into();
                write!(f, "{}", ss)
            }
            Error::TaskGroupNameExist(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::TaskGroupNameExist(data.clone(), _param.clone()).into();
                write!(f, "{}", ss)
            }
            Error::TaskGroupSizeError(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::TaskGroupSizeError(data.clone(), _param.clone()).into();
                write!(f, "{}", ss)
            }
            Error::TaskGroupStatusError(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::TaskGroupStatusError(data.clone(), _param.clone()).into();
                write!(f, "{}", ss)
            }
            ...
            Error::TaskGroupUsedSizeError(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::TaskGroupUsedSizeError(data.clone(), _param.clone()).into();
                write!(f, "{}", ss)
            }
            Error::TaskGroupQueueReleaseError(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::TaskGroupQueueReleaseError(data.clone(), _param.clone()).into();
                write!(f, "{}", ss)
            }
            Error::TaskGroupQueueAwakeError(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::TaskGroupQueueAwakeError(data.clone(), _param.clone()).into();
                write!(f, "{}", ss)
            }
            Error::CreateTaskGroupError(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::CreateTaskGroupError(data.clone(), _param.clone()).into();
                write!(f, "{}", ss)
            }
            Error::UpdateTaskGroupError(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::UpdateTaskGroupError(data.clone(), _param.clone()).into();
                write!(f, "{}", ss)
            }
            Error::QueryTaskGroupListError(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::QueryTaskGroupListError(data.clone(), _param.clone()).into();
                write!(f, "{}", ss)
            }
            Error::CloseTaskGroupError(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::CloseTaskGroupError(data.clone(), _param.clone()).into();
                write!(f, "{}", ss)
            }
            Error::StartTaskGroupError(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::StartTaskGroupError(data.clone(), _param.clone()).into();
                write!(f, "{}", ss)
            }
            Error::QueryTaskGroupQueueListError(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::QueryTaskGroupQueueListError(data.clone(), _param.clone()).into();
                write!(f, "{}", ss)
            }
            Error::TaskGroupCacheStartFailed(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::TaskGroupCacheStartFailed(data.clone(), _param.clone()).into();
                write!(f, "{}", ss)
            }
            Error::EnvironmentWorkerGroupsIsInvalid(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::EnvironmentWorkerGroupsIsInvalid(data.clone(), _param.clone()).into();
                write!(f, "{}", ss)
            }
            Error::UpdateEnvironmentWorkerGroupRelationError(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::UpdateEnvironmentWorkerGroupRelationError(data.clone(), _param.clone())
                        .into();
                write!(f, "{}", ss)
            }
            Error::TaskGroupQueueAlreadyStart(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::TaskGroupQueueAlreadyStart(data.clone(), _param.clone()).into();
                write!(f, "{}", ss)
            }
            Error::TaskGroupStatusClosed(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::TaskGroupStatusClosed(data.clone(), _param.clone()).into();
                write!(f, "{}", ss)
            }
            Error::TaskGroupStatusOpened(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::TaskGroupStatusOpened(data.clone(), _param.clone()).into();
                write!(f, "{}", ss)
            }
            Error::NotAllowToDisableOwnAccount(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::NotAllowToDisableOwnAccount(data.clone(), _param.clone()).into();
                write!(f, "{}", ss)
            }
            Error::NotAllowToDeleteDefaultAlarmGroup(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::NotAllowToDeleteDefaultAlarmGroup(data.clone(), _param.clone()).into();
                write!(f, "{}", ss)
            }
            Error::TimeZoneIllegal(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::TimeZoneIllegal(data.clone(), _param.clone()).into();
                write!(f, "{}", ss)
            }
            Error::QueryK8sNamespaceListPagingError(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::QueryK8sNamespaceListPagingError(data.clone(), _param.clone()).into();
                write!(f, "{}", ss)
            }
            Error::K8sNamespaceExist(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::K8sNamespaceExist(data.clone(), _param.clone()).into();
                write!(f, "{}", ss)
            }
            Error::CreateK8sNamespaceError(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::CreateK8sNamespaceError(data.clone(), _param.clone()).into();
                write!(f, "{}", ss)
            }
            Error::UpdateK8sNamespaceError(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::UpdateK8sNamespaceError(data.clone(), _param.clone()).into();
                write!(f, "{}", ss)
            }
            Error::K8sNamespaceNotExist(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::K8sNamespaceNotExist(data.clone(), _param.clone()).into();
                write!(f, "{}", ss)
            }
            Error::K8sClientOpsError(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::K8sClientOpsError(data.clone(), _param.clone()).into();
                write!(f, "{}", ss)
            }
            Error::VerifyK8sNamespaceError(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::VerifyK8sNamespaceError(data.clone(), _param.clone()).into();
                write!(f, "{}", ss)
            }
            Error::DeleteK8sNamespaceByIdError(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::DeleteK8sNamespaceByIdError(data.clone(), _param.clone()).into();
                write!(f, "{}", ss)
            }
            Error::VerifyParameterNameFailed(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::VerifyParameterNameFailed(data.clone(), _param.clone()).into();
                write!(f, "{}", ss)
            }
            Error::StoreOperateCreateError(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::StoreOperateCreateError(data.clone(), _param.clone()).into();
                write!(f, "{}", ss)
            }
            Error::GrantK8sNamespaceError(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::GrantK8sNamespaceError(data.clone(), _param.clone()).into();
                write!(f, "{}", ss)
            }
            Error::QueryUnauthorizedNamespaceError(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::QueryUnauthorizedNamespaceError(data.clone(), _param.clone()).into();
                write!(f, "{}", ss)
            }
            Error::QueryAuthorizedNamespaceError(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::QueryAuthorizedNamespaceError(data.clone(), _param.clone()).into();
                write!(f, "{}", ss)
            }
            Error::QueryCanUseK8sClusterError(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::QueryCanUseK8sClusterError(data.clone(), _param.clone()).into();
                write!(f, "{}", ss)
            }
            Error::ResourceFullNameTooLongError(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::ResourceFullNameTooLongError(data.clone(), _param.clone()).into();
                write!(f, "{}", ss)
            }
            Error::TenantFullNameTooLongError(data, _param) => {
                let ss: AuroraErrorInfo =
                    Error::TenantFullNameTooLongError(data.clone(), _param.clone()).into();
                write!(f, "{}", ss)
            }
        }
    }
...
impl From<AuroraErrorInfo> for Error {
    fn from(value: AuroraErrorInfo) -> Self {
        match (
            ...
            (10047, ..) => {
                Error::QueryProjectDetailsByCodeError(value.error_data, value.error_param)
            } //(10047, "query project details by code error", "查询项目详细信息错误"),
            (10048, ..) => Error::CreateProjectError(value.error_data, value.error_param), //(10048, "create project error", "创建项目错误"),
            (10049, ..) => {
                Error::LoginUserQueryProjectListPagingError(value.error_data, value.error_param)
            ...
            (10051, ..) => {
                Error::QueryUnauthorizedProjectError(value.error_data, value.error_param)
            } //(10051, "query unauthorized project error", "查询未授权项目错误"),
            ...
            (10059, ..) => {
                Error::VerifyResourceByNameAndTypeError(value.error_data, value.error_param)
            ...
            (10061, ..) => {
                Error::CreateResourceFileOnLineError(value.error_data, value.error_param)
            } //(10061, "create resource file online error", "创建资源文件错误"),
            ...
            (10068, ..) => {
                Error::QueryUdfFunctionListPagingError(value.error_data, value.error_param)
            ...
            (10083, ..) => {
                Error::QueryTaskRecordListPagingError(value.error_data, value.error_param)
            } //(10083, "query task record list paging error", "分页查询任务记录错误"),
            ...
            (10104, ..) => {
                Error::DownloadTaskInstanceLogFileError(value.error_data, value.error_param)
            ...
            (10106, ..) => {
                Error::VerifyProcessDefinitionNameUniqueError(value.error_data, value.error_param)
            ...
            (10108, ..) => {
                Error::ReleaseProcessDefinitionError(value.error_data, value.error_param)
            } //(10108, "release process definition error", "上线工作流错误"),
            (10109, ..) => {
                Error::QueryDetailOfProcessDefinitionError(value.error_data, value.error_param)
            ...
            (10111, ..) => {
                Error::EncapsulationTreeviewStructureError(value.error_data, value.error_param)
            } //(10111, "encapsulation treeview structure error", "查询工作流树形图数据错误"),
            (10112, ..) => {
                Error::GetTasksListByProcessDefinitionIdError(value.error_data, value.error_param)
            } //(10112, "get tasks list by process definition id error", "查询工作流定义节点信息错误"),
            (10113, ..) => {
                Error::QueryProcessInstanceListPagingError(value.error_data, value.error_param)
            } //(10113, "query process instance list paging error", "分页查询工作流实例列表错误"),
            (10114, ..) => {
                Error::QueryTaskListByProcessInstanceIdError(value.error_data, value.error_param)
            ...
            (10116, ..) => {
                Error::QueryProcessInstanceByIdError(value.error_data, value.error_param)
            } //(10116, "query process instance by id error", "查询工作流实例错误"),
            ...
            (10118, ..) => Error::QuerySubProcessInstanceDetailInfoByTaskIdError(
                value.error_data,
                value.error_param,
            ...
            (10120, ..) => {
                Error::QueryProcessInstanceAllVariablesError(value.error_data, value.error_param)
            } //(10120, "query process instance all variables error", "查询工作流自定义变量信息错误"),
            (10121, ..) => Error::EncapsulationProcessInstanceGanttStructureError(
                value.error_data,
                value.error_param,
            ), //(10121, "encapsulation process instance gantt structure error", "查询工作流实例甘特图数据错误"),
            (10122, ..) => {
                Error::QueryProcessDefinitionListPagingError(value.error_data, value.error_param)
            ...
            (10126, ..) => {
                Error::ScheduleCronReleaseNeedNotChange(value.error_data, value.error_param)
            ...
            (
                ...
                "请先删除全部工作流定义",
                ..,
            ) => Error::DeleteProjectErrorDefinesNotNull(value.error_data, value.error_param), //(10137, "please delete the process definitions in project first!", "请先删除全部工作流定义"),
            (10138, ..) => {
                Error::BatchDeleteProcessInstanceByIdsError(value.error_data, value.error_param)
            ...
            (10151, ..) => {
                Error::SwitchProcessDefinitionVersionError(value.error_data, value.error_param)
            ...
            (10154, ..) => {
                Error::QueryProcessDefinitionVersionsError(value.error_data, value.error_param)
            } //(10154, "query process definition versions error", "查询工作流历史版本信息出错"),
            (10156, ..) => {
                Error::DeleteProcessDefinitionVersionError(value.error_data, value.error_param)
            ...
            (10158, ..) => {
                Error::ProcessDefinitionCodesIsEmpty(value.error_data, value.error_param)
            } //(10158, "process definition codes is empty", "工作流CODES不能为空"),
            (10159, ..) => {
                Error::BatchCopyProcessDefinitionError(value.error_data, value.error_param)
            } //(10159, "batch copy process definition error", "复制工作流错误"),
            (10160, ..) => {
                Error::BatchMoveProcessDefinitionError(value.error_data, value.error_param)
            } //(10160, "batch move process definition error", "移动工作流错误"),
            (10161, ..) => Error::QueryWorkflowLineageError(value.error_data, value.error_param), //(10161, "query workflow lineage error", "查询血缘失败"),
            (10162, ..) => Error::QueryAuthorizedAndUserCreatedProjectError(
                value.error_data,
                value.error_param,
            ), //(10162, "query authorized and user created project error error", "查询授权的和用户创建的项目错误"),
            (10163, ..) => {
                Error::DeleteProcessDefinitionByCodeFail(value.error_data, value.error_param)
            } //(10163, "delete process definition by code fail, for there are {0} process instances in executing using it", "删除工作流定义失败，有[{0}]个运行中的工作流实例正在使用"),
            ...
            (10166, ..) => {
                Error::TaskInstanceStateOperationError(value.error_data, value.error_param)
            } //(10166, "the status of task instance {0} is {1},Cannot perform force success operation", "任务实例[{0}]的状态是[{1}]，无法执行强制成功操作"),
            ...
            (10175, ..) => {
                Error::CreateWorkerGroupForbiddenInDocker(value.error_data, value.error_param)
            } //(10175, "create worker group forbidden in docker ", "创建worker分组在docker中禁止"),
            (10176, ..) => {
                Error::DeleteWorkerGroupForbiddenInDocker(value.error_data, value.error_param)
            ...
            (10181, ..) => {
                Error::CurrentLoginUserTenantNotExist(value.error_data, value.error_param)
            ...
            (20016, ..) => {
                Error::ResourceNotExistOrNoPermission(value.error_data, value.error_param)
            } //(20016, "resource not exist or no permission,please view the task node and remove error resource", "请检查任务节点并移除无权限或者已删除的资源"),
            ...
            (
                ...
                "存在子工作流定义不是上线状态",
                ..,
            ) => Error::SubProcessDefineNotRelease(value.error_data, value.error_param), //(50004, "exist sub process definition not online", "存在子工作流定义不是上线状态"),
            (50005, ..) => {
                Error::ProcessInstanceAlreadyChanged(value.error_data, value.error_param)
            } //(50005, "the status of process instance {0} is already {1}", "工作流实例[{0}]的状态已经是[{1}]"),
            (50006, ..) => {
                Error::ProcessInstanceStateOperationError(value.error_data, value.error_param)
            } //(50006, "the status of process instance {0} is {1},Cannot perform {2} operation", "工作流实例[{0}]的状态是[{1}]，无法执行[{2}]操作"),
            ...
            (50009, ..) => {
                Error::ProcessInstanceExecutingCommand(value.error_data, value.error_param)
            } //(50009, "process instance {0} is executing the command, please wait ...", "工作流实例[{0}]正在执行命令，请稍等..."),
            (50010, ..) => {
                Error::ProcessInstanceNotSubProcessInstance(value.error_data, value.error_param)
            ...
            (50012, ..) => {
                Error::CountProcessInstanceStateError(value.error_data, value.error_param)
            } //(50012, "count process instance state error", "查询各状态流程实例数错误"),
            (50013, ..) => {
                Error::CountProcessDefinitionUserError(value.error_data, value.error_param)
            ...
            (
                ...
                "批量运行工作流实例错误: {0}",
                ..,
            ) => Error::BatchStartProcessInstanceError(value.error_data, value.error_param), //(50014, "batch start process instance error: {0}", "批量运行工作流实例错误: {0}"),
            ...
            (
                ...
                "批量删除工作流定义[{0}]错误",
                ..,
            ) => Error::BatchDeleteProcessDefineByCodesError(value.error_data, value.error_param), //(50026, "batch delete process definition by codes {0} error", "批量删除工作流定义[{0}]错误")
            (
                50026,
                "delete process definition by codes {0} error",
                "删除工作流定义[{0}]错误",
                ..,
            ) => Error::DeleteProcessDefineByCodesError(value.error_data, value.error_param), //(50026, "delete process definition by codes {0} error", "删除工作流定义[{0}]错误")
            (
                50027,
            ...
            (
                ...
                "批量导出工作流定义错误",
                ..,
            ) => Error::BatchExportProcessDefineByIdsError(value.error_data, value.error_param), //(50028, "batch export process definition by ids error", "批量导出工作流定义错误")
            ...
            (
                ...
                "工作流任务关系[{0}]不存在",
                ..,
            ) => Error::ProcessTaskRelationNotExist(value.error_data, value.error_param), //(50033, "process task relation [{0}] does not exist", "工作流任务关系[{0}]不存在")
            (
                50034,
            ...
            (
                ...
                "任务定义名称[{0}]已经存在",
                ..,
            ) => Error::TaskDefinitionNameExisted(value.error_data, value.error_param), //(50045, "task definition name [{0}] already exists", "任务定义名称[{0}]已经存在")
            ...
            (70012, ..) => {
                Error::QueryAccesstokenListPagingError(value.error_data, value.error_param)
            ...
            (80003, ..) => {
                Error::StartTimeBiggerThanEndTimeError(value.error_data, value.error_param)
            ...
            (110004, ..) => {
                Error::QueryPluginDetailResultIsNull(value.error_data, value.error_param)
            } //(110004, "query plugin detail result is null", "查询插件详情结果为空")

            (110005, ..) => {
                Error::UpdateAlertPluginInstanceError(value.error_data, value.error_param)
            } //(110005, "update alert plugin instance error", "更新告警组和告警组插件实例错误")
            (110006, ..) => {
                Error::DeleteAlertPluginInstanceError(value.error_data, value.error_param)
            ...
            (110008, ..) => {
                Error::CreateAlertPluginInstanceError(value.error_data, value.error_param)
            } //(110008, "create alert plugin instance error", "创建告警组和告警组插件实例错误")
            (110009, ..) => {
                Error::QueryAllAlertPluginInstanceError(value.error_data, value.error_param)
            ...
            (110011, ..) => {
                Error::ListPagingAlertPluginInstanceError(value.error_data, value.error_param)
            } //(110011, "query plugin instance page error", "分页查询告警实例失败")
            (110012, ..) => Error::DeleteAlertPluginInstanceErrorHasAlertGroupAssociated(
                value.error_data,
                value.error_param,
            ...
            (110013, ..) => {
                Error::ProcessDefinitionVersionIsUsed(value.error_data, value.error_param)
            ...
            (120007, ..) => {
                Error::DeleteEnvironmentRelatedTaskExists(value.error_data, value.error_param)
            } //(120007, "this environment has been used in tasks,so you can't delete it.", "该环境已经被任务使用，所以不能删除该环境信息")
            (1200008, ..) => {
                Error::QueryEnvironmentByNameError(value.error_data, value.error_param)
            } //(1200008, "not found environment [{0}] ", "查询环境名称[{0}]信息不存在")
            (1200009, ..) => {
                Error::QueryEnvironmentByCodeError(value.error_data, value.error_param)
            } //(1200009, "not found environment [{0}] ", "查询环境编码[{0}]不存在")
            ...
            (1200015, ..) => {
                Error::QueryRuleInputEntryListError(value.error_data, value.error_param)
            } //(1200015, "query rule list error", "获取规则列表错误")
            (1200016, ..) => {
                Error::QueryExecuteResultListPagingError(value.error_data, value.error_param)
            ...
            (1200019, ..) => {
                Error::GetDatasourceTableColumnsError(value.error_data, value.error_param)
            } //(1200019, "get datasource table columns error", "获取数据源表列名错误")
            ...
            (130013, ..) => {
                Error::QueryTaskGroupQueueListError(value.error_data, value.error_param)
            } //(130013, "query task group queue list error", "查询任务组队列列表错误")
            (130014, ..) => Error::TaskGroupCacheStartFailed(value.error_data, value.error_param), //(130014, "cache start failed", "任务组相关的缓存启动失败")
            (130015, ..) => {
                Error::EnvironmentWorkerGroupsIsInvalid(value.error_data, value.error_param)
            } //(130015, "environment worker groups is invalid format", "环境关联的工作组参数解析错误")
            (130016, ..) => Error::UpdateEnvironmentWorkerGroupRelationError(
                value.error_data,
                value.error_param,
            ...
            (130030, ..) => {
                Error::NotAllowToDeleteDefaultAlarmGroup(value.error_data, value.error_param)
            ...
            (1300001, ..) => {
                Error::QueryK8sNamespaceListPagingError(value.error_data, value.error_param)
            ...
            (1300008, ..) => {
                Error::DeleteK8sNamespaceByIdError(value.error_data, value.error_param)
            } //(1300008, "delete k8s namespace by id error", "删除命名空间错误")
            ...
            (1300012, ..) => {
                Error::QueryUnauthorizedNamespaceError(value.error_data, value.error_param)
            } //(1300012, "query unauthorized namespace error", "查询未授权命名空间错误")
            (1300013, ..) => {
                Error::QueryAuthorizedNamespaceError(value.error_data, value.error_param)
            } //(1300013, "query authorized namespace error", "查询授权命名空间错误")
            ...
            (1300015, ..) => {
                Error::ResourceFullNameTooLongError(value.error_data, value.error_param)
            } //(1300015, "resource's fullname is too long error", "资源文件名过长")
...
impl From<Error> for AuroraErrorInfo {
    fn from(status: Error) -> Self {
        match status {
            ...
            Error::UserNameNull (data,_param)=> AuroraErrorInfo::new(
                10004,
                "user name is null".to_string(),
                "用户名不能为空".to_string(),
            ).new_with_data(data),
            Error::HdfsOperationError (data,_param)=> AuroraErrorInfo::new(
                10006,
            ...
            Error::UserNotExist (data,_param)=> AuroraErrorInfo::new(
                10010,
                "user {0} not exists".to_string(),
                "用户[{0}]不存在".to_string(),
            ).new_with_data(data),
            Error::AlertGroupNotExist (data,_param)=> AuroraErrorInfo::new(
                10011,
            ...
            Error::TenantNotExist (data,_param)=> AuroraErrorInfo::new(
                10017,
            ...
            Error::ScheduleStatusUnknown (data,_param)=> AuroraErrorInfo::new(
                10026,
            ...
            Error::UserLoginFailure (data,_param)=> AuroraErrorInfo::new(
                10043,
            ...
            Error::CreateProjectError (data,_param)=> AuroraErrorInfo::new(
                10048,
            ...
            Error::DeleteProjectError (data,_param)=> AuroraErrorInfo::new(
                10050,
            ...
            Error::CreateResourceError (data,_param)=> AuroraErrorInfo::new(
                10054,
                "create resource error".to_string(),
                "创建资源错误".to_string(),
            ).new_with_data(data),
            Error::UpdateResourceError (data,_param)=> AuroraErrorInfo::new(
                10055,
            ...
            Error::DeleteResourceError (data,_param)=> AuroraErrorInfo::new(
                10058,
            ...
            Error::CreateTenantError (data,_param)=> AuroraErrorInfo::new(
                10084,
            ...
            Error::UpdateTenantError (data,_param)=> AuroraErrorInfo::new(
                10087,
            ...
            Error::CreateUserError (data,_param)=> AuroraErrorInfo::new(
                10090,
            ...
            Error::UpdateUserError (data,_param)=> AuroraErrorInfo::new(
                10092,
                "update user error".to_string(),
                "更新用户错误".to_string(),
            ).new_with_data(data),
            Error::DeleteUserByIdError (data,_param)=> AuroraErrorInfo::new(
                10093,
                "delete user by id error".to_string(),
                "删除用户错误".to_string(),
            ).new_with_data(data),
            Error::GrantProjectError (data,_param)=> AuroraErrorInfo::new(
                10094,
                "grant project error".to_string(),
                "授权项目错误".to_string(),
            ).new_with_data(data),
            Error::GrantResourceError (data,_param)=> AuroraErrorInfo::new(
                10095,
            ...
            Error::GetUserInfoError (data,_param)=> AuroraErrorInfo::new(
                10098,
                "get user info error".to_string(),
                "获取用户信息错误".to_string(),
            ).new_with_data(data),
            Error::UserListError (data,_param)=> AuroraErrorInfo::new(
                10099,
                "user list error".to_string(),
                "查询用户列表错误".to_string(),
            ).new_with_data(data),
            Error::VerifyUsernameError (data,_param)=> AuroraErrorInfo::new(
                10100,
            ...
            Error::QueryParentProcessInstanceDetailInfoBySubProcessInstanceIdError (data,_param)=>AuroraErrorInfo::new(
                    10119,
            ...
            Error::IpIsEmpty (data,_param)=> AuroraErrorInfo::new(
                10125,
            ...
            Error::CreateQueueError (data,_param)=> AuroraErrorInfo::new(
                10127,
            ...
            Error::QueueNameExist (data,error_param)=>{
                ...
                AuroraErrorInfo::new(10130,"queue name {0} already exists".to_string(),
"队列名称[{0}]已存在".to_string(),                ).new_with_data(data)
                .parse(error_param)
            }
            Error::UpdateQueueError (data,_param)=> AuroraErrorInfo::new(
                10131,
            ...
            Error::VerifyQueueError (data,_param)=> AuroraErrorInfo::new(
                10133,
                "verify queue error".to_string(),
                "验证队列信息错误".to_string(),
            ).new_with_data(data),
            Error::NameNull (data,_param)=> AuroraErrorInfo::new(
                10134,
            ...
            Error::UdfFunctionNotExist (data,_param)=> AuroraErrorInfo::new(
                20001,
            ...
            Error::ResourceNotExist (data,_param)=> AuroraErrorInfo::new(
                20004,
                "resource not exist".to_string(),
                "资源不存在".to_string(),
            ).new_with_data(data),
            Error::ResourceExist (data,_param)=> AuroraErrorInfo::new(
                20005,
            ...
            Error::DataIsNotValid (data,_param)=> AuroraErrorInfo::new(
                50017,
                "data {0} not valid".to_string(),
                "数据[{0}]无效".to_string(),
            ).new_with_data(data),
            Error::DataIsNull (data,_param)=> AuroraErrorInfo::new(
                50018,
            ...
            Error::ProcessDagIsEmpty (data,_param)=> AuroraErrorInfo::new(
                50035,
            ...
            Error::HdfsNotStartup (data,_param)=> AuroraErrorInfo::new(
                60001,
                "hdfs not startup".to_string(),
                "hdfs未启用".to_string(),
            ).new_with_data(data),
            Error::StorageNotStartup (data,_param)=> AuroraErrorInfo::new(
                60002,
            ...
            Error::GenerateTokenError (data,_param)=> AuroraErrorInfo::new(
                70011,
            ...
            Error::NegativeSizeNumberError (data,_param)=> AuroraErrorInfo::new(
                80002,
            ...
            Error::QueueCountError (data,_param)=> AuroraErrorInfo::new(
                90001,
            ...
            Error::QueryPluginsError (data,_param)=> AuroraErrorInfo::new(
                110003,
            ...
            Error::TaskGroupFull (data,_param)=> AuroraErrorInfo::new(
                130004,
            ...
            Error::GrantK8sNamespaceError (data,_param)=> AuroraErrorInfo::new(
                1300011,
