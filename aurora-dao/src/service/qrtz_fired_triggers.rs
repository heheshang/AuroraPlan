...
impl QrtzFiredTriggersService for AuroraRpcServer {
    ...
    ) -> std::result::Result<tonic::Response<proto::qrtz_fired_triggers::ListQrtzFiredTriggerssResponse>, tonic::Status>
    {
        todo!()
    }
    ...
    ) -> std::result::Result<tonic::Response<proto::qrtz_fired_triggers::QrtzFiredTriggers>, tonic::Status> {
        todo!()
    }
